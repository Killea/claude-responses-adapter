...
describe('Metadata Utilities', () => {
    beforeEach(() => {
        ...
        // Create adapter metadata directory
        const adapterDir = join(TEST_DIR, '.claude-responses-adapter');
    ...
    afterEach(() => {
        // Clean up test files
        try {
            const metadataPath = join(TEST_DIR, '.claude-responses-adapter', 'metadata.json');
